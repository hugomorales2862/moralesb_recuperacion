    ...
    <form action="/moralesb_recuperacion/controladores/visita/guardar.php" method="POST" class="col-lg-8 border bg-light p-3">
      <div class="row mb-3">
        ...
        <div class="col">
          ...
          <input type="number" name="hora_ingreso" id="hora_ingreso" class="form-control" required>
        </div>
        <div class="col">
          <label for="hora_salida" class="form-label">Ingrese la Hora de salida</label>
          <input type="number" name="hora_salida" id="hora_salida" class="form-control" required>
        </div>
        </div>
      </div>
      <div class="row mb-3">
